...
public class WishlistRecipeEntity {
    ...
    public WishlistRecipeEntity(@NonNull String id, String nama, String penulis, String ditulis, String waktu, String porsi, String kesulitan, String kategori, String deksripsi, String foto, ArrayList<String> bahan, ArrayList<String> caraMasak) {
        this.id = id;
        this.nama = nama;
